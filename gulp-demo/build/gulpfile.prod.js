...
function prod() {
    ...
    gulp.task('js', function () {
        return gulp.src(Config.js.src).pipe(gulp.dest(Config.js.dist)).pipe(rename({
            suffix: '.min'
        })).pipe(bable()).pipe(uglify()).pipe(gulp.dest(Config.js.dist));
    });
    /** 
     * 合并所有js文件并做压缩处理 
     */
    gulp.task('js-concat', function () {
        return gulp.src(Config.js.src).pipe(concat(Config.js.build_name)).pipe(gulp.dest(Config.js.dist)).pipe(rename({
            suffix: '.min'
        })).pipe(bable()).pipe(uglify()).pipe(gulp.dest(Config.js.dist)).on('error', function (err) {
    ...
    gulp.task('build', ['html', 'css', 'sass', 'js', 'assets', 'img']);
}
module.exports = prod;